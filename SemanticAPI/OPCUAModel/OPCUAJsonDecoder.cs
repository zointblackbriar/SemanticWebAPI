...
{
    public class OPCUAJsonDecoder : JsonDecoder
    {
        ...
        private OPCUAJsonDecoder(string json, NodeId dataTypeId, Session session, int[] dimensions) : base(json, session.MessageContext)
        {
            if (session == null)
        ...
        public static OPCUAJsonDecoder CreateDecoder(string json, NodeId dataTypeId, Session session, int[] dimensions = null)
        {
            return new OPCUAJsonDecoder(json, dataTypeId, session, dimensions);
        }
...
;
        ...
        public new NodeId ReadNodeId(string fieldName)
        {
            ...
            return ParserUtils.ParsePlatformNodeIdString(value);
        }
